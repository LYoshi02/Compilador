...
public class Compilador extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        directorio = new Directory(this, jtpCode, windowTitle, ".c");
    ...
    private void fillTableTokens() {
        controladorCompilador.getTokens().forEach(token -> {
    ...
    private String formatCompilationErrorMessage(ArrayList<ErrorLSSL> errors) {
